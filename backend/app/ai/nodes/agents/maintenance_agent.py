"""Maintenance and management specialist agent node (covers contracts and cadastros domains)."""
...
async def maintenance_agent_node(state: AgentState) -> dict:
    ...
    try:
        ...
        return {
            "agent_response": rule_based_response(
                classification.get("intentId", "maintenance_overview"), context, state.get("question", "")
            ),
